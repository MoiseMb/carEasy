 ...
 * @author moisemb
 */
public class panelVoitureSupprimer extends javax.swing.JPanel {

    /**
     * Creates new form panelVoitureAjout
     */
    public panelVoitureSupprimer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Supprimer Voiture");
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 530, 140, 30));
        ...
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 410, -1, 30));
        ...
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, -3, 860, 810));
    ...
    private void rechercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rechercherActionPerformed
       ...
       BufferedImage image2 = null;
        ...
        image.setIcon(icon);
            ...
            Logger.getLogger(panelVoitureSupprimer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    Voiture v=new Voiture(immatriculation.getText(),modele.getText(),marque.getText(),Integer.valueOf(annee.getText()),Integer.valueOf(place.getText()),Integer.valueOf(kilometrage.getText()),true,Enumcarburant.valueOf(carburant.getText().toUpperCase()),Integer.valueOf(prix.getText()));
        ...
        v.supprimerVoiture();
        File fichier = new File("photoVoiture/"+immatriculation.getText()+".png");
        fichier.delete();
