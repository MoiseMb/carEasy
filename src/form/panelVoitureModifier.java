 ...
 * @author moisemb
 */
public class panelVoitureModifier extends javax.swing.JPanel {

    /**
     * Creates new form panelVoitureAjout
     */
    public panelVoitureModifier() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modifier Voiture");
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 540, 160, 30));
        ...
        add(prix, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 350, 200, 30));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(image, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 590, Short.MAX_VALUE)
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(image, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 340, Short.MAX_VALUE)
        );

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 590, 340));
        ...
        add(disponible, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 570, 140, 30));

        jLabel12.setFont(new java.awt.Font("Helvetica Neue", 3, 22)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("nombre place");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 430, -1, 30));
        ...
        add(place, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 460, 60, 30));

        valider.setBackground(new java.awt.Color(51, 153, 0));
        valider.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        ...
        add(valider, new org.netbeans.lib.awtextra.AbsoluteConstraints(688, 683, 130, 30));

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form/background.jpeg"))); // NOI18N
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 810));
    ...
    private void rechercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rechercherActionPerformed
        ...
        image.setIcon(icon);
            ...
            Logger.getLogger(panelVoitureModifier.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validerActionPerformed
        ...
        if(disponible.getText().isBlank()){
        
        JOptionPane.showMessageDialog(null, "Effectuer dabord une recherche");
    ...
    Voiture v=new Voiture(immatriculation.getText(),modele.getText(),marque.getText(),Integer.valueOf(annee.getText()),Integer.valueOf(place.getText()),Integer.valueOf(kilometrage.getText()),true,Enumcarburant.valueOf(carburant.getText().toUpperCase()),Integer.valueOf(prix.getText()));
