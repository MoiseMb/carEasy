 ...
 * @author moisemb
 */
public class panelClientSupprimer extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("NOM");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 280, 74, 30));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 430, -1, -1));
        ...
        add(nom, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 310, 300, 30));
        ...
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 570, 90, -1));
        ...
        confirmer.setBackground(new java.awt.Color(102, 153, 0));
    ...
    private void confirmerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmerActionPerformed
        ...
        classeconnexion conn = new classeconnexion(); //connexion a la base de donnees 
        prepare = conn.conn.prepareStatement("delete from Client  where email=?");
 
        prepare.setString(1, mail);
        
         int result = prepare.executeUpdate(); // execute la requête et retourne le nombre de lignes affectées
        if(result > 0){
            JOptionPane.showMessageDialog(null, "Suprression  réussi");
